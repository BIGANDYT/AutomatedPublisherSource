...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Sitecore" /mediaBookList "Sitecore Automated Publisher module" /productName "Sitecore Automated Publisher module"
